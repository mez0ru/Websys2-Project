<div>
<button style="float: right;" class="btn btn-primary" type="button" data-toggle="modal" data-target="#addJobModal" wire:click="resetInput"><b>Create a new job
    posting</b></button>

<div wire:ignore.self class="modal fade" id="addJobModal" tabindex="-1" aria-labelledby="AddNewJob" aria-hidden="true">
